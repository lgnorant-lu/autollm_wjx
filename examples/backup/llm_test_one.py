"""
----------------------------------------------------------------
File name:                  llm_test_one.py
Author:                     Ignorant-lu
Date created:               2025/04/02
Description:                测试单个LLM提供商
----------------------------------------------------------------
...
def main():
    ...
    """
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='测试单个LLM提供商')
    parser.add_argument('--provider', '-p', type=str, required=True,
